...
# ==========================================================================
# 4D MODEL: Howard policy evaluation (NO-ADJUSTMENT regime)
# Given FIXED policy (w', s), with d' pinned by idp_map.
#
# IMPORTANT:
# We should NOT mutate gidx in-place (your current version does).
# It creates cross-iteration side effects and breaks threading assumptions.
# Build a fresh gidx_out with d pinned.
# ==========================================================================

function howard_noadjust(queue::Array{Float64,4}, util::Array{Float64,5},
    idp_map::Vector{Int}, gidx::dtp.Ipol,
...
# Output policy indices: same w,s as input; d pinned deterministically
gidx_out = dtp.Ipol(
copy(gidx.w),
