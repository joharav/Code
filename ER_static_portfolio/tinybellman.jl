# ==========================================================================
# 4D MODEL: Local search Bellman (tinybellman) for ADJUSTMENT regime
# Searches only in a neighborhood of the previous policy
# ==========================================================================
        ...
        for iw in 1:sz.nw
            for iy in 1:sz.ny
                for ie in 1:sz.ne
                    ...
                    @inbounds for idp in idp_lo:idp_hi
