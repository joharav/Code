function tinybellman(queuelong::Array{Float64,4}, util::Array{Float64,6},
...
idp_lo = max(1, old_idp - sz.pad); idp_hi = min(sz.npd, old_idp + sz.pad)
...
for idp in idp_lo:idp_hi, iwp in iwp_lo:iwp_hi
