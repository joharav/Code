function printstuff(answ::NamedTuple)
    ...
    filename = "Specification_3/Output/Policy/v.txt"
    io = open(filename, "w")
    ...
    filename = "Specification_3/Output/Policy/a.txt"
    io = open(filename, "w")
    ...
    filename = "Specification_3/Output/Policy/d.txt"
    io = open(filename, "w")
    ...
    filename = "Specification_3/Output/Policy/c.txt"
    io = open(filename, "w")
    ...
    filname = "Specification_3/Output/Policy/statespace.txt"
