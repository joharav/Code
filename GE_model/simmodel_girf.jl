...
function simmodel_girf(answ::NamedTuple, T_shock::Int)
    ...
    outtuple = (v=allv_shock::Array{Float64}, d=alld_shock::Array{Float64}, a=alla_shock::Array{Float64}, ex=alle_shock::Array{Float64},d_adjust=alld_adjust_shock::Array{Float64},adjust_indicator=adjust_indicator::Array{Float64}, c=allc_shock::Array{Float64}, z=allz_shock::Array{Float64})
