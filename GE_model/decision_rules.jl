...
function decision_rules(answ)
    ...
    iz = 1
    for id in 1:sz.nd
        heatmap(a, ex, adjust_indicator_policy[iz, :, :, id],
    ...
    for ia in 1:sz.na
        heatmap(d, ex, adjust_indicator_policy[iz, :, ia, :],
            ylabel="Exchange Rate",
    ...
    for id in 1:sz.nd
        heatmap(a, ex, d_change_adjust[iz, :, :, id],
            ylabel="Exchange Rate",
            xlabel="Initial Assets",
    ...
    for ia in 1:sz.na
        heatmap(d, ex, d_change_adjust[iz, :, ia, :],
            ylabel="Exchange Rate",
            xlabel="Initial Durables",
    ...
    for id in 1:sz.nd
        heatmap(a, ex, d_sign_adjust[iz, :, :, id],
            ylabel="Exchange Rate",
            xlabel="Initial Assets",
    ...
    for ia in 1:sz.na
        heatmap(d, ex, d_sign_adjust[iz, :, ia, :],
            ylabel="Exchange Rate",
            xlabel="Initial Durables",
