module sz;
    ...
    const ne        = 11;            #number of points in the shock grid
    ...
    const nmom      = 8;             #number of moments to calculate
    ...
    const nop       = 9;             #maximum number of parameters
...
module kst;
    ...
    const rho_e    = 0.9;      # AR(1) persistence for durable price
    const sigma  = 0.2;        # Volatility of durable price shock
    const sigma_e  = 0.2;      # Volatility of durable price shock
