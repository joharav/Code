function makegrids(ppp::Vector{Float64});
    ...
    outtuple = (p=pg::Vector{Float64},t=trans::Array{Float64},a=ag::Vector{Float64},ap=apg::Vector{Float64},d=dg::Vector{Float64},dp = dpg::Vector{Float64}, ex = eg::Vector{Float64});
    return outtuple::NamedTuple{(:p,:t,:a,:ap,:d,:dp,:ex)};
end
