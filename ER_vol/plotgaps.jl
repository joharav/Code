function plotgaps(x_values::Vector{Float64}, f_x::Vector{Float64}, h_x::Vector{Float64}, gap_vec::Vector{Float64})
    ...
    # Save the plot
    savefig(p, joinpath(output_dir, "Gaps_distr_probability.png"))
    ...
    savefig(hist, joinpath(output_dir, "Gap_histogram.png"))
    ...
    savefig(p1, joinpath(output_dir, "Gaps_distr.png"))
    ...
    savefig(p2, joinpath(output_dir, "Gaps_probability.png"))
