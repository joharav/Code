...
function compute_cirf(irf_results::Vector{Float64}, window_size::Int,x::String)
    ...
    savefig(pp1, "Specification_3/Output/IRFs/CIRF_($param_str).png")
