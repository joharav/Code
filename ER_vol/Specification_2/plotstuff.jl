...
function plotstuff(vee::Array{Float64, 3}, apol::Array{Int64, 3}, dpol::Array{Int64, 3},  cpol::Array{Float64, 3}, g::NamedTuple)
    ...
    for ie in 1:sz.ne
        ...
        savefig(plot1, "Specification_2/Output/Policy/vf_slice_e$(ie).png")

        plot2 = surface(a, d, dapol_slice, xlabel="Assets", ylabel="Durables", zlabel="Optimal Assets")
        savefig(plot2, "Specification_2/Output/Policy/Apolicy_slice_e$(ie).png")

        plot3 = surface(a, d, ddpol_slice, xlabel="Assets", ylabel="Durables", zlabel="Optimal Durables")
        savefig(plot3, "Specification_2/Output/Policy/Dpolicy_slice_e$(ie).png")

        plot4 = surface(a, d, dcpol_slice, xlabel="Assets", ylabel="Durables", zlabel="Optimal Consumption")
        savefig(plot4, "Specification_2/Output/Policy/Cpolicy_slice_e$(ie).png")
        ...
        # Save the plot
        savefig(plot5, "Specification_2/Output/Policy/Dpolicy_lines.png")
        ...
        # Save the plot
        savefig(plot5a, "Specification_2/Output/Policy/Dpolicy_lines_dlow.png")
        ...
        # Save the plot
        savefig(plot5b, "Specification_2/Output/Policy/Dpolicy_lines_dhigh.png")
        ...
        savefig(plot6, "Specification_2/Output/Policy/Apolicy_lines.png")
        ...
        # Save the plot
        savefig(plot6a, "Specification_2/Output/Policy/Apolicy_lines_dlow.png")
        ...
        # Save the plot
        savefig(plot6b, "Specification_2/Output/Policy/Apolicy_lines_dhigh.png")
