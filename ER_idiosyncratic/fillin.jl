function fillin(obj::Array{Float64}, g::NamedTuple)
  ...
  objlong = zeros(sz.ne, sz.ny, sz.npa, sz.npd)
    ...
    Threads.@threads for id in 1:sz.npd
      ...
      Threads.@threads for iy in 1:sz.ny
        Threads.@threads for ie in 1:sz.ne
          objlong[ie, iy, ia, id] = afrac * (dfrac * obj[ie, iy, aup, dup] + (1 - dfrac) * obj[ie, iy, aup, ddown]) +
          (1 - afrac) * (dfrac * obj[ie, iy, adown, dup] + (1 - dfrac) * obj[ie, iy, adown, ddown])
        end 
      end
    end
  end
