...
#I want aggregate e, idiosyncratic y 
    global e_sequence = grids.ex[rand(1:sz.ne, sz.nYears+1)]  # Common e for each year
...
#            all_picke[iti, ifi] = div(pick_combined - 1, sz.ny) + 1
    ...
    outtuple = (v=allv::Array{Float64}, d=alld::Array{Float64}, a=alla::Array{Float64}, ex=alle::Array{Float64},d_adjust=alld_adjust::Array{Float64},adjust_indicator=adjust_indicator::Array{Float64},c=allc::Array{Float64},y=ally::Array{Float64},ls=ls::Array{Float64},picke=all_picke,picky=all_picky)
    return outtuple::NamedTuple{(:v, :d, :a, :ex, :d_adjust, :adjust_indicator, :c, :y, :ls, :picke, :picky)}
end