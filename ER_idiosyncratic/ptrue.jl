function ptrue(enn::Int64)
    ...
    pea[3] = 0.7;                               # rho_e    = persistence
    pea[4] = 0.7;                               # sigma_e  = exchange rate innovation standard deviation
    ...
    pea[14] = 0.7;                              # rho_y    = AR(1) persistence for idiosyncratic income
    pea[15] = 0.7;                               # sigma_y  = Volatility of idiosyncratic income shock
