function ptrue(enn::Int64)
    ...
    pea[7] = 0.7;                               # f        = adj cost 0.3 gives you a 3% adj
    pea[8] = 1;                                  # w        = wage rate
    pea[9] = 0.2;                                # chi      = Required maintenance 
    pea[10] = 5;                                 # pd      = price durable goods
    pea[11] = 0.7;                              # ft      = fixed cost on wage rate
    pea[12] = 0.25;                              # tau      = tax rate
    pea[13] = 1/3;                               # h        = hours worked
    pea[14] = 0.9;                              # rho_y    = AR(1) persistence for idiosyncratic income
    pea[15] = 0.4;                               # sigma_y  = Volatility of idiosyncratic income shock
