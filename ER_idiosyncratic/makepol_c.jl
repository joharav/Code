        ...
        Threads.@threads for ia in 1:sz.na;
            Threads.@threads for iy in 1:sz.ny;            
                Threads.@threads for ie in 1:sz.ne;
                    if ind==0
                        cpol[ie,iy,ia,id] = w * h * (1-tau)*y[iy] + e[ie] * a[ia] * (1 .+  rr) - e[ie] * pd * delta * chi * d[id] -  e[ie] *  apol[ie,iy,ia,id]
                    else
                        cpol[ie,iy,ia,id] = w * h * (1-tau)*y[iy] + e[ie] * a[ia] * (1 .+  rr) + e[ie] * pd * (1 - f) * (1 - delta) * d[id] -   e[ie] *  apol[ie,iy,ia,id] - e[ie] * pd * dpol[ie,iy,ia,id] - w * h * ft*y[iy]
                    end;
